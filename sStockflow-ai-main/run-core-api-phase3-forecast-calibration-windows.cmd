...
echo ============================================================
echo StockFlow AI Phase 3 Increment 5B.1
echo Forecast Calibration and Diagnostics
echo ============================================================
echo Database: %STOCKFLOW_DB_URL%
echo Profile:  phase2
echo Migration: V012__add_forecast_calibration_and_diagnostics.sql
echo.
...
echo Diagnostics: http://localhost:8080/api/v1/forecasts/diagnostics
echo Calibration: http://localhost:8080/api/v1/forecasts/calibration-summary
