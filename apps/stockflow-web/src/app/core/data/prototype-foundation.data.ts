...
export function createPrototypeFoundationData(tenantId: string, tenantName: string): PrototypeFoundationData {
  const warehouses: WarehouseView[] = [
    { warehouseId: 'WH-CHENNAI', warehouseName: 'Chennai Central', city: 'Chennai', state: 'Tamil Nadu', country: 'India', capacityUnits: 180000, coldChainAvailable: true },
    { warehouseId: 'WH-BENGALURU', warehouseName: 'Bengaluru North', city: 'Bengaluru', state: 'Karnataka', country: 'India', capacityUnits: 145000, coldChainAvailable: true },
    { warehouseId: 'WH-HYDERABAD', warehouseName: 'Hyderabad Hub', city: 'Hyderabad', state: 'Telangana', country: 'India', capacityUnits: 165000, coldChainAvailable: true },
    { warehouseId: 'WH-COIMBATORE', warehouseName: 'Coimbatore West', city: 'Coimbatore', state: 'Tamil Nadu', country: 'India', capacityUnits: 92000, coldChainAvailable: false },
    { warehouseId: 'WH-MYSURU', warehouseName: 'Mysuru DC', city: 'Mysuru', state: 'Karnataka', country: 'India', capacityUnits: 78000, coldChainAvailable: false }
  ];
